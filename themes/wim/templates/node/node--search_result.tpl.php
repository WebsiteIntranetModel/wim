...
/**
 * @file
 * Default theme implementation to display the node search result.
 *
 * Available variables:
 ...
 * - $content-type: Content type label.
 *
...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <div class="submitted">
    <?php if (!empty($content['field_publication_date'])): ?>
      ...
      ?>
    <?php elseif (!empty($content['field_agenda_date'])): ?>
