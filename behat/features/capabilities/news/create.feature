...
# @todo: An "Upload a new file" widget has been replaced with "plupload" (drag & drop). So, will be need to re-write this part.
# For now just commented these steps until we get behat method which support drag & drop files.
